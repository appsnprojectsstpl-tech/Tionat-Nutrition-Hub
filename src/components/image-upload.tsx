...
import { compressImage, getOptimalSettings } from '@/lib/image-compression';
...
export function ImageUpload({ value, onChange, disabled }: ImageUploadProps) {
    ...
    const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!originalFile || !storage) return;

        setIsUploading(true);
        try {
            // Compress Image with optimal settings for products
            const file = await compressImage(originalFile, getOptimalSettings('product'));
